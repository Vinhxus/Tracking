...
export default function SideNav(){
    ...
    return(
        <nav className="flex flex-col gap-2 w-40 border rounded-l-2xl h-screen">
            <div className="flex items-center gap-2 mt-2">
                <Trophy className="ml-2 " size={19} color="yellow" />
                <span className="bg-linear-to-r from-blue-600 via-indigo-500 to-purple-600 bg-clip-text text-2xl text-transparent font-extrabold tracking-tight">
                    Tracking
                </span>
            </div>
            <button
